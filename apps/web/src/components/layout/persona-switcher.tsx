...
export function PersonaSwitcher() {
  ...
  return (
    <select
      ...
      className="glass h-10 rounded-full px-4 text-sm font-medium text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
