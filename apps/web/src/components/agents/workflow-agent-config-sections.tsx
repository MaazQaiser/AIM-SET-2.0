    ...
    <div className="space-y-8">
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          <Label className="text-xs text-muted-foreground">Summary override</Label>
          <textarea
        ...
        <ul className="space-y-3">
          {rules.map((rule, index) => (
            ...
            >
              ...
              <input
                className="flex h-9 w-full rounded-md border bg-background px-3 py-1 text-sm font-mono"
                value={rule.pattern}
                readOnly={readOnly}
                onChange={(e) => {
                  const next = [...rules];
