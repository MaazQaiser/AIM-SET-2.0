...
SIGNAL_RULES: List[Tuple[str, List[str], ChecklistItemStatus]] = [
    ("budget", ["budget", "pricing", "cost", "spend", "investment", "approved budget", "dollar"], "partial"),
    ("budget", ["budget approved", "allocated", "signed off", "funding approved"], "confirmed"),
    ("authority", ["decision maker", "economic buyer", "sign off", "cio", "cto", "vp ", "director", "board"], "partial"),
    ("authority", ["reports to", "final say", "signatory", "approves"], "confirmed"),
    ("need", ["pain", "problem", "challenge", "struggling", "need to", "priority", "impact"], "partial"),
    ("need", ["must have", "critical", "urgent need", "business case"], "confirmed"),
    ("timeline", ["timeline", "deadline", "go-live", "launch", "q1", "q2", "q3", "q4", "by end of"], "partial"),
    ("timeline", ["board meeting", "decision by", "kick off", "start date"], "confirmed"),
    ("success_criteria", ["success looks like", "success criteria", "kpi", "outcome"], "partial"),
    ("stakeholders", ["stakeholder", "who else", "involved", "team members", "evaluating"], "partial"),
    ("decision_process", ["procurement", "rfp", "evaluation process", "steps to"], "partial"),
    ("current_state", ["currently", "today we", "our stack", "existing system"], "partial"),
    ("competition", ["competitor", "alternative", "incumbent", "build in-house", "vendor"], "partial"),
    ("next_step", ["follow up", "next meeting", "schedule", "send proposal", "loop in"], "partial"),
    ("next_step", ["booked for", "calendar invite", "see you next"], "confirmed"),
    ("compliance_security", ["compliance", "regulatory", "soc 2", "gdpr", "audit", "security requirement"], "partial"),
    ("engagement_fit", ["engagement model", "staff aug", "fixed price", "t&m", "outsource"], "partial"),
]
